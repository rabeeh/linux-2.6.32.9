...
void initialize_raptor()
{
	...
	value = 0x61;
	i2c_write_bytes(AD9889_ADDRESS, 0x9D, &value, 1);
	value = 0x87;
...
{
	/*
	 * ADI9889 D[23:0] = Red[23:16], Green[15:8], Blue[7:0]
	 * data sequnce = a1~a4, b1~b4, c1~c4.
	 * each data occupies 2 bytes.
	 ...
	 */
	/*
	 * w/o RBSwap. source is R[23:16], G[15:8], B[7:0]
	 * 1. Rout = a1*Rin
	 * 2. Gout = b2*Gin
	 * 3. Bout = c3*Bin
	 */
	...
	/*
	 * w/ RBSwap. source is R[7:0], G[15:8], B[23:16]
	 * 1. Rout = a3*Bin
	 * 2. Gout = b2*Gin
	 * 3. Bout = C1*Rin
	 */
