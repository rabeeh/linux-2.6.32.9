...
unsigned int use_ncq = 0;
module_param(use_ncq, int, 0);
MODULE_PARM_DESC(use_ncq, "Allow NCQ configuration, otherwise use non queued. "
                "(default: 0)");
...
static int __devinit mv_ial_init_soc_sata(void)
{
    ...
    else if (MV_6781_DEV_ID == mvCtrlModelGet())
	pAdapter->maxHosts = MV_SATA_6781_PORT_NUM;
