...
#define IRQ_GPP_START IRQ_DOVE_GPIO_START
...
#define PMU_SCRATCHPAD_INT_BASE	(DOVE_SB_REGS_VIRT_BASE + MV_PMU_REGS_OFFSET + 0xC000)					 
#define PMU_SCRATCHPAD_INT_BASE_PHYS	(DOVE_SB_REGS_PHYS_BASE + MV_PMU_REGS_OFFSET + 0xC000)
